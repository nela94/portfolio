      ...
      <div id="aboutmecontained" className={styles.container}>
        ...
        <div className={styles.row}>
          ...
          <div style={{display: 'inline-block', paddingRight: '210px'}} className={styles.column}>
            <p style={{marginTop: '100px',fontSize:'20px'}}>I was born and raised in Queens, New York. I also have Honduran and Salvadoran roots!
              Before getting into programming I was in the Real Estate industry, where I started as a receptionist
              and ended up becoming an agent, all in the span of four years. I loved interacting with all the different type of people
